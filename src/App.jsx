...
const App = () => {
    const videos1 = [
        'src/Data10/BDMAP_00000020.mp4',
        'src/Data10/BDMAP_00000031.mp4',
        'src/Data10/BDMAP_00000205.mp4'
    ];

    const videos2 = [
        'src/Data10/BDMAP_00000006.mp4',
        'src/Data10/BDMAP_00000031.mp4',
    ];
        ...
        <div className="main-container">
            ...
            <section id="bodymaps-section" className="info-section">
                <div className="header">
                    <img src="src/Data10/logo_white_bg.png" alt="BodyMaps Illustration" className="header-image"/>
